...
<%
     CProveedores pro=(CProveedores)request.getAttribute("pro");
     CPersonas per=(CPersonas)request.getAttribute("per");
     CUsuario usu=(CUsuario)request.getAttribute("usu");;
     ArrayList<CContacto> con=(ArrayList)request.getAttribute("con");;
     ArrayList<CDirecciones> dir=(ArrayList)request.getAttribute("dir");;
     out.println(per.valor[2]);
%>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <ul class="list-unstyled team-members">
                                            <li>
                                                <div class="row">
                                                    <form action="VProveedorController" method="post">                                                    
                                                        <div class="col-xs-2">
                                                            <div class="avatar">
                    ...
                    <div class="col-lg-8 col-md-7">
                            ...
                            <div class="content">
                                <ul class="list-unstyled team-members">
                                    <li>
                                                <form action="VProveedorController" method="post" method="post">                                                    
                                                    <div class="row">
