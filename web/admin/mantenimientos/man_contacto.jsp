...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        $('#contacto tbody').on('click', 'tr', function () {
                ...
                document.getElementById("con3").value=data[3];
        ...
        <div class="btn-group">
			...
			<table id="contacto" class="table table-striped table-bordered table-hover table-condensed dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <%
                    ...
                    CContacto contac1=new CContacto();
                for(CContacto p: con_datos){
                   out.print("<tr>");
                   for(int i=0;i<contac1.n;i++){
            ...
            <div class="modal-body">
                 ...
                 <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="id_persona" id="idcon3" required/>
                    </div>
                  </div>
          ...
          <div class="modal-body">
            ...
            <input type="text" class="form-control hide" name="_id" id="con0" required/>
                 ...
                 <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon">Persona</span>
                      <input type="text" class="form-control" name="id_persona" id="con3" required/>
                    </div>
                  </div>
