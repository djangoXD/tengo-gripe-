...
public class AdministradoresController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           DAdministradores dp=new DAdministradores();
           CAdministradores cp=new CAdministradores();
           String res="";
...
//                    out.println(res);
  ...
  //                  out.println(res);
    ...
    //                out.println(res);
                ...
                request.getRequestDispatcher("mantenimientos/man_administradores.jsp").include(request, response);
