 ...
 * @author WARREN
 */
public class Compras_detalleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
           ...
           DCompras_detalle dp=new DCompras_detalle();
           CCompras_detalle cp=new CCompras_detalle();
           String res="";
...
//                    out.println(res);
  ...
  //                  out.println(res);
    ...
    //                out.println(res);
                ...
                request.getRequestDispatcher("mantenimientos/man_compras_detalle.jsp").include(request, response); 
