 ...
 * @author WARREN
 */
public class Ventas_detalleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
           ...
           DVentas_detalle dp=new DVentas_detalle();
           CVentas_detalle cp=new CVentas_detalle();
           String res="";
...
//                    out.println(res);
  ...
  //                  out.println(res);
    ...
    //                out.println(res);
                ...
                request.getRequestDispatcher("mantenimientos/man_ventas_detalle.jsp").include(request, response);
