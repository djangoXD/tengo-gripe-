...
import clases.CProveedor_Categoria;
 ...
 * @author Dennys
 */
public class DProveedor_Categoria implements Operaciones {
    
    private String database;
    private String tabla;
    private String url;

    public DProveedor_Categoria() {
       ADcon gg=new ADcon();
        this.database=gg.getDatabase();
        this.tabla="proveedor_categoria";
        this.url=gg.getUrl();
     }

    public DProveedor_Categoria(String database, String tabla, String url) {
    ...
    public String insertar(Object o) {
        ...
        CProveedor_Categoria x=(CProveedor_Categoria)o;       
        String res="";
    ...
    public ArrayList consultar() {
        String res="";
        CProveedor_Categoria x=new CProveedor_Categoria();
        ...
        try{
            while(cursor.hasNext()){               
                ...
                BasicDBObject agg=(BasicDBObject)cursor.next();  
                    ...
                    datos.add(new CProveedor_Categoria(k));                                           
            }
        } finally{
            cursor.close();
        }  
    ...
    public CProveedor_Categoria buscar_id(String id){
        String res="";
        CProveedor_Categoria x=new CProveedor_Categoria();
        ArrayList datos=new ArrayList();
        MongoClient mongo=null;
        ...
        if(datos.size()==0)return new CProveedor_Categoria();
        return (CProveedor_Categoria) datos.get(0);
    }
